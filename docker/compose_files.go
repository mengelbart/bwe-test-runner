...
services:
  ...
  tcp_sender:
    ...
    cap_add:
      - NET_ADMIN
    entrypoint: /iperf.sh -i 0.2 -C reno -J --logfile /log/tcp.log -t 100
...
services:
  ...
  tcp_sender:
    ...
    cap_add:
      - NET_ADMIN
    entrypoint: /iperf.sh -i 0.2 -C bbr -J --logfile /log/tcp.log -t 100
